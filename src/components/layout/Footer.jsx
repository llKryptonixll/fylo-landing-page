...
const Footer = () => {
  ...
  const iconStyles = "h-4 w-4 border-[1px] rounded-full p-2 hover:text-bright_blue hover:border-bright_blue transition-colors"
  const linkHover = "hover:text-bright_blue transition-colors"

  return (
    <footer className="bg-very_dark_blue flex xl:space-y-0 space-y-12 xl:flex-row flex-col xl:space-x-52 min-h-[380px] text-light_grayish_blue md:px-padding px-paddingSmall py-14">
      <div className="xl:self-center grid gap-8">
      ...
      <div className="flex lg:flex-row flex-col lg:space-y-0 space-y-12 lg:space-x-52 xl:self-end">
        <ul className="grid gap-[0.65rem]">
          <li>
            <a className={linkHover} href="#">About Us</a>
          </li>
          <li>
            <a className={linkHover} href="#">Jobs</a>
          </li>
          <li>
            <a className={linkHover} href="#">Press</a>
          </li>
          <li>
            <a className={linkHover} href="#">Blog</a>
          </li>
        </ul>

        <ul className="grid gap-[0.65rem]">
          <li>
            <a className={linkHover} href="#">Contact Us</a>
          </li>
          <li>
            <a className={linkHover} href="#">Terms</a>
          </li>
          <li>
            <a className={linkHover} href="#">Privacy</a>
          </li>
        </ul>
        <ul className="flex space-x-4 sm:m-0 m-auto">
          <li>
            <a aria-label="our facebook page" href="#">
              <FontAwesomeIcon className={iconStyles} icon={faFacebookF} />
            </a>
          </li>
          <li>
            <a aria-label="our twitter page" href="#">
              <FontAwesomeIcon className={iconStyles} icon={faTwitter} />
            </a>
          </li>
          <li>
